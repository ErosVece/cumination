...
def Main():
    site.add_dir(
        ...
        f'{site.url}allcategories/',
        'Cat',
        site.img_cat,
    )
    site.add_dir(
        '[COLOR hotpink]Censored[/COLOR]',
        f'{site.url}category/censored',
        'List',
        site.img_search,
    )
    site.add_dir(
        '[COLOR hotpink]Unensored[/COLOR]',
        f'{site.url}category/uncensored',
        'List',
        site.img_search,
    )
    site.add_dir(
        '[COLOR hotpink]Amateur[/COLOR]',
        f'{site.url}category/amateur-jav',
        'List',
        site.img_search,
    )
    site.add_dir(
        '[COLOR hotpink]Chinese Subtitles[/COLOR]',
        f'{site.url}category/chinese-subtitles',
        'List',
        site.img_search,
    )
    site.add_dir(
